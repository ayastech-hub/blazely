    ...
    >
      ...
      >
        ...
        <div
          style={{
            borderColor: isNew
              ? "rgba(150,214,205,0.4)"
              : "rgba(30,41,59,0.6)",

            boxShadow: isNew
              ? "0 0 24px rgba(150,214,205,0.12)"
              : "none",
          }}
            ...
            {token.graduated ? (
              ...
              <div className="w-full">
                ...
                >
                  ...
                  <span>
                    {Number(token.pool_progress || 0).toFixed(1)}%
                  </span>
                ...
                <div className="w-full h-1.5 bg-[#030712] border border-slate-800/50 overflow-hidden rounded-full">

                  <div
                    className="h-full bg-teal rounded-full"
                    style={{
                      width:`${Math.min(Number(token.pool_progress || 0),100)}%`
                    }}
                  />
